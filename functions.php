...
if ( ! function_exists( 'travelblog_setup' ) ) :
	...
	function travelblog_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'travelblog' ),
		) );
 ...
 */
function travelblog_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'travelblog_content_width', 640 );
}
add_action( 'after_setup_theme', 'travelblog_content_width', 0 );
...
function travelblog_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'travelblog' ),
...
function travelblog_scripts() {
	...
	wp_enqueue_script( 'travelblog-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'travelblog-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
